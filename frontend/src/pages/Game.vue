...
const difficulties = {
	싱글모드: { cols: 17, rows: 10 },
	// 멀티모드: { cols: 17, rows: 10 },
	// 대전모드: { cols: 17, rows: 10 },
};
...
<template>
	<div class="game-container">
		...
		<div v-else class="game-content">
			...
			<!-- 하단 타이머/버튼 -->
			<GameFooter :timeLeft="timeLeft" :maxTime="maxTime" @reset="resetGame" />

			<!-- 게임 종료 모달 -->
			<GameOverModal v-if="gameOver" v-model="username" @confirm="handleGameOverConfirm" @skip="skipRegistration" />
		</div>
