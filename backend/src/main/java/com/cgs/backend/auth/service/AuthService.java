...
public class AuthService {
    ...
    public TokenResponse reissue(TokenReissueRequest request) {
        ...
        return new TokenResponse(newAccessToken, request.getRefreshToken(), user.getUserId(), user.getNickname(), user.getUserRecord().getWins(), user.getUserRecord().getLosses());
    }
